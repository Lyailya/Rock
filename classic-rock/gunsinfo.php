...
<div class="col-md-3 col-lg-3 col-sm-xs-3" style="height:800px;">
	<div class="albums"><img src="appetite.jpg" alt="..." style ="width:100%"></div>
</div>
<div class="col-md-4 col-lg-4 col-sm-xs-4">
<div class="audio" style="margin-top:100px;"><audio src="/music/good_enough.mp3">
<p>If you are reading this, it is because your browser does not support the audio element.     </p>
</audio>
<audio controls label="hi">
  <source src="music.ogg" type="audio/ogg">
  <source src="albums\guns\appetite\Nightrain.mp3" type="audio/mpeg" label="hi">
	<track kind="captions" src="music.en.vtt" srclang="en" label="English">
Your browser does not support the audio element.
</audio>
<br>
<div class="audio" style="margin-top:10px;"><audio src="/music/good_enough.mp3">
<p>If you are reading this, it is because your browser does not support the audio element.     </p>
</audio>
<audio controls label="hi">
  <source src="music.ogg" type="audio/ogg">
  <source src="music.mp3" type="audio/mpeg" label="hi">
	<track kind="captions" src="music.en.vtt" srclang="en" label="English">
Your browser does not support the audio element.
</audio>
<div class="audio" style="margin-top:10px;"><audio src="/music/good_enough.mp3">
...
<div class="col-md-5 col-lg-5 col-sm-xs-5" style="margin-top:50px">
	<div class="add">
